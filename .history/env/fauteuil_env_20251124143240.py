...
class FauteuilEnv(gym.Env):
    ...
    def _draw_human_fov(self, surface, human_pos, human_direction, color=(100, 155, 100, 100)):
        """
    ...
    for i in range(num_points + 1):
        ...
        x = center_px[0] + length * 50 * math.cos(angle)
        y = center_px[1] + length * 50 * math.sin(angle)
        points.append((x, y))
