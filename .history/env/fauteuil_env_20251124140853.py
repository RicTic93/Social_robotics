...
class FauteuilEnv(gym.Env):
    ...
    def _draw_fov(self, surface, center, direction, angle_deg=140, color=(0, 255, 255, 100)):
        ...
        pygame.draw.arc(
            fov_surface, color,
            (center_px[0] - self.fov_distance * 50, center_px[1] - self.fov_distance * 50,
            self.fov_distance * 100, self.fov_distance * 100),
    ...
    def _draw_human_fov(self, surface, human_pos, human_direction, color=(255, 0, 0, 100)):
        ...
        pygame.draw.arc(
            fov_surface, color,
            (center_px[0] - self.human_fov_distance * 50, center_px[1] - self.human_fov_distance * 50,
            self.human_fov_distance * 100, self.human_fov_distance * 100),
            start_angle, end_angle, 2
        )
    ...
    def render(self):
        ...
        self._draw_fov(self.screen, self.robot_pos, direction, angle_deg=120, length=5.0, color=(0, 255, 155, 100))
