...
class FauteuilEnv(gym.Env):
    ...
    def _draw_fov(self, surface, center, direction, angle_deg=140, length=5.0, color=(0, 255, 255, 100)):
        """
        ...
        :param length: Longueur des lignes du FOV.
        ...
        end_point1 = (
            center_px[0] + length * 50 * math.cos(start_angle),
            center_px[1] + length * 50 * math.sin(start_angle)
        )
        end_point2 = (
            center_px[0] + length * 50 * math.cos(end_angle),
            center_px[1] + length * 50 * math.sin(end_angle)
        )
        ...
        pygame.draw.arc(
            fov_surface, color,
            (center_px[0] - length * 50, center_px[1] - length * 50,
    ...
    self._draw_fov(self.screen, self.robot_pos, direction, angle_deg=140, length=5.0, color=(0, 255, 255, 100))
