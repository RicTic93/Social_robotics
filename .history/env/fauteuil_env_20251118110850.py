...
class FauteuilEnv(gym.Env):
    def __init__(self, config):
        ...
        # Utilisation des paramètres depuis config
        self.num_objects = config['num_objects']
        self.dynamic_humans_count = config['dynamic_humans_count']
        self.social_distance = config['social_distance']
        self.static_groups = config['static_groups']
