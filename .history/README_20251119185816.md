...
|-------------------------|------------|----------------------|
| Atteindre le but        | +10        | Objectif atteint Termine l'épisode      |
| Collision humain        | -10        | Episode continue     |
| Collision obstacle      | -3         | Episode continue     |

Sociales zones
| Zone       | Distance (m) | Récompense | Description               |
|------------|--------------|------------|---------------------------|
| Intime     | < 0.4        | -5         | Zone intrusive            |
| Personnelle| 0.4-1.2      | -2         | Zone d confort           |
